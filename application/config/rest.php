...
| example:
|
|			$config['auth_override_class_method']['deals']['view']['get'] = 'none';
|			$config['auth_override_class_method']['deals']['insert']['post'] = 'digest';
|			$config['auth_override_class_method']['accounts']['user']['put'] = 'basic';
|
| Here 'deals' and 'accounts' are controller names, 'view', 'insert' and 'user' are methods within, 'get', 'post', 'put' request methods. 
