...
<?endforeach?>
<tr>
	<td><?=$BC->_getFieldTitle("section")?>: <span class="red">*</span></td>
	<td><?=form_input("section",set_value("section",@$section));?></td>
</tr>
<tr>
...
<tr>
	<td><?=$BC->_getFieldTitle("connector")?>:</td>
	<td><?=form_dropdown("connector",array('AND'=>'AND','OR'=>'OR'),set_value('connector',@$connector));?></td>
</tr>
</table>
