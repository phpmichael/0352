	...
	<tbody>
		...
		<tr>
		    <td style='text-align:left'> 
		    	<?//=((userAccess('products','edit'))?anchor_base("products/edit/id/asc/0/".$item['product_id'],$product_name):$product_name)?>
		    	<?=((userAccess('books','edit'))?anchor_base("books/view/pub_date/asc/0/".$item['product_id'],$product_name):$product_name)?>
