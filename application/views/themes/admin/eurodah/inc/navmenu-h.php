...
<div id="menu-left">
  ...
  <ul id="navmenu-h">
    ...
    <?if(userAccess('assortment','view')):?>
    <li><?=$BC->buildLeftMenuItem('assortment','assortment')?>
        <ul>
            <li><?=anchor_base('products_categories', "Категорії")?></li>
        </ul>
    </li>
    <?endif?>
    ...
    <li><a href="javascript:void(0)"><?=language('content')?></a>
      ...
      <ul>
        ...
        <?if(userAccess('partner_slider','view')):?>
        <li><?=anchor_base('partner_slider', "Слайдшоу партнерів")?></li>
        <?endif?>
