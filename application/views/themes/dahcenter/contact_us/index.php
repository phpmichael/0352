                    ...
                    <div class="fieldset">
                        ...
                        <div>
                        	...
                        	<div class="captcha-row">
                        	   <div class="captcha-image"><?=$cap_img?></div>
                        	   <div class="captcha-input"><input type="text" name="captcha" value="" class="form-text" /></div>
...
<script type="text/javascript">
    ymaps.ready(function () {
        ...
        mapPlgPM1.controls
            ...
            .add('typeSelector');
        mapPlgPM1.balloon.open([49.551075, 25.593044], '<div style="color:black"><h3>«Дахцентр»</h3><div>м. Тернопіль, вул. Руська 21, 7 поверх</div></div>');
    });
</script>