...
<body>
        ...
        <div id="page">
			<header id="header">
				<div class="section-1 clearfix">
					<div class="col1">
						<a href="<?=base_url()?>" title="<?=language('home_page')?>" rel="home" id="logo">
							<span id="logo-mark"><span id="logo-mark-wall"></span><span id="logo-mark-roof"></span></span>
							<span id="logo-word">ДАХЦЕНТР</span>
						</a>
					</div>

                    <div id="header-title">
                        <div>Покрівельні матеріали</div>
                        <div>Тернопіль</div>
                    </div>
				...
				<div class="section-2 clearfix">
					<button id="nav-toggle" type="button" aria-label="Меню" aria-expanded="false" aria-controls="block-superfish-1">
    ...
    (function(){
        ...
        var nav = document.getElementById('block-superfish-1');
        if(!btn || !nav) return;
