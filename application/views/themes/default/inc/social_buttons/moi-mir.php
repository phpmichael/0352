...
?>
<a onclick="window.open('https://connect.mail.ru/share?share_url=<?=urlencode($social_params['page_url'])?>', 'moimir', 'width=626, height=436'); return false;" href="http://connect.mail.ru/share?share_url=<?=urlencode($social_params['page_url'])?>" rel="nofollow" title="<?=$social_params['button_title']?>">
