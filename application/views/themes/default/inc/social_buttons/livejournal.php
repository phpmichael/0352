...
?>
<a onclick="window.open('https://www.livejournal.com/update.bml?event=<?=urlencode($social_params['page_url'])?>&amp;subject=<?=urlencode($head['page_title'])?>', 'livejournal', 'width=626, height=436'); return false;" href="https://www.livejournal.com/update.bml?event=<?=urlencode($social_params['page_url'])?>&amp;subject=<?=urlencode($head['page_title'])?>" rel="nofollow" title="<?=$social_params['button_title']?>">
