...
?>
<a onclick="window.open('https://www.facebook.com/sharer.php?u=<?=urlencode($social_params['page_url'])?>', 'facebook', 'width=626, height=436'); return false;" href="http://www.facebook.com/sharer.php?u=<?=urlencode($social_params['page_url'])?>" rel="nofollow" title="<?=$social_params['button_title']?>">
