...
?>
<a onclick="window.open('https://vkontakte.ru/share.php?url=<?=urlencode($social_params['page_url'])?>', 'vkontakte', 'width=626, height=436'); return false;" href="https://vkontakte.ru/share.php?url=<?=urlencode($social_params['page_url'])?>" rel="nofollow" title="<?=$social_params['button_title']?>">
