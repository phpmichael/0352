            ...
            <div id="header">
                <div class="header-1">
                    ...
                    <div class="top-right">
                    	...
                    	<a href="https://vk.com/klavishko"><?=img(array('src'=>$BC->_getTheme().'images/vkontakte.png','width'=>24,'height'=>24,'class'=>'move-down'))?> vk.com/klavishko</a>
                    	<a href="https://facebook.com/klavishko"><?=img(array('src'=>$BC->_getTheme().'images/facebook.png','width'=>24,'height'=>24,'class'=>'move-down'))?> facebook.com/klavishko</a>
