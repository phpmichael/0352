...
<title><?if($BC->_getController()=='products' && in_array($BC->_getMethod(),array('view','name')) && @$page_title):?><?=$page_title?><?elseif(!$BC->is_home_page() && $head['page_title']):?><?=$head['page_title']?><?else:?><?=$head['site_title']?><?endif?></title>
