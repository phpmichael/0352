<div itemscope itemtype="https://schema.org/Book">
    ...
    <div class="well book-view">
        <div class="book-view-top">
            <div class="book-view-media">
                ...
                <?if(@$photo1):?>
                <p class="book-view-image">
                    <a href="<?=base_url().'images/data/b/books/'.$photo1?>" class="product-image" data-lightbox="product-image">
                        <?=img(array('src'=>'images/data/b/books/'.$photo1, 'alt'=>htmlspecialchars($name)))?>
                    </a>
                </p>
                <?endif?>
            </div>

            <div class="book-view-summary">
                    ...
                    <div class="book-purchase-box">
                        <?if($in_stock):?>
                            <div class="book-purchase-row">
                                <?=form_input('qty',1,"size='1' class='input-mini book-qty-input' style='margin:0;'")?>
                        ...
                        <div class="book-meta">
                            ...
                            <?if($manufacturer):?>
                            <p>
                                <strong><?=fb_input_label("manufacturer_id","books")?>:</strong>
