...
abstract class REST_Controller extends CI_Controller
{
	...
	*/
	...
	protected function _auth_override_check()
	{
		...
		if (empty($this->overrides_array[$this->router->class][$this->router->method][$this->request->method]))
		{
			return false;
		}

		// None auth override found, prepare nothing but send back a true override flag
		if ($this->overrides_array[$this->router->class][$this->router->method][$this->request->method] == 'none')
		{
			return true;
		}

		// Basic auth override found, prepare basic
		if ($this->overrides_array[$this->router->class][$this->router->method][$this->request->method] == 'basic')
		{
			$this->_prepare_basic_auth();
			return true;
		}
		...
		if ($this->overrides_array[$this->router->class][$this->router->method][$this->request->method] == 'digest')
		{
			$this->_prepare_digest_auth();
			return true;
		}
		...
		if ($this->overrides_array[$this->router->class][$this->router->method][$this->request->method] == 'whitelist')
		{
			$this->_check_whitelist_auth();
			return true;
		}
