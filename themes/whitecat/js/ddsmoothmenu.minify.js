var ddsmoothmenu={arrowimages:{down:['downarrowclass',window.base_url+'themes/whitecat/images/down.gif',0],right:['rightarrowclass',window.base_url+'themes/whitecat/images/right.gif']},transition:{overtime:300,outtime:300},shadow:{enable:false,offsetx:0,offsety:0},showhidedelay:{showdelay:200,hidedelay:100},detectwebkit:navigator.userAgent.toLowerCase().indexOf("applewebkit")!=-1,detectie6:document.all&&!window.XMLHttpRequest,css3support:window.msPerformance||(!document.all&&document.querySelector),getajaxmenu:function($,setting){var $menucontainer=$('#'+setting.contentsource[0])
...
var $jQ=jQuery.noConflict();$jQ(document).ready(function($){if(typeof setting.contentsource=="object"){ddsmoothmenu.getajaxmenu($,setting)}
